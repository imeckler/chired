...
Elm.Main.make = function (_elm) {
   ...
   var SetDB = function (a) {
      return {ctor: "SetDB",_0: a};
   };
   var SetVote = F2(function (a,
   b) {
      return {ctor: "SetVote"
             ,_0: a
             ,_1: b};
   });
   var ClickDown = function (a) {
      return {ctor: "ClickDown"
             ,_0: a};
   };
   var ClickUp = function (a) {
      return {ctor: "ClickUp"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
   ...
   var decodeUpdate = function () {
      var fromResult = function (ex) {
         return function () {
            switch (ex.ctor)
            {case "Err":
               return Error(ex._0);
...
Elm.Util.make = function (_elm) {
   ...
   var filterMap = function () {
      ...
      return function (f) {
         return function ($) {
            return $Signal.map(fromJust)(A2($Signal.keepIf,
            isJust,
            $Maybe.Nothing)($Signal.map(f)($)));
         };
      };
   }();
